...
public final class MainWindowController {
  ...
  private void handleManualButtonAction(ActionEvent event) {
    ...
    try {
      if (main.getMyConfig().getDestinationDir()
          .equals("bitte Ziel-Verzeichnis auswählen")) {
        ...
        alert.setContentText(
            "Bitte legen Sie das Quell- und Zielverzeichnis fest");
        alert.showAndWait();
        ...
        if (!myFile.exists()) {
          ...
          dialog.setHeaderText(main.getMyConfig().getDestinationDir()
          ...
          main.getPrimarayStage()
              .setTitle(main.getTitle() + " - " + "Manuelle Ablage");
      ...
      System.out
          .println("Fehler in MainWindowController - handleManualButtonAction");
      e.printStackTrace();
    }
  ...
  private void handleSearchButton(ActionEvent event) {
    ...
    try {
      ...
      main.getPrimarayStage()
          .setTitle(main.getTitle() + " - " + "Dokument suchen...");
      anchorDetails.getChildren().setAll(pane);
    } catch (Exception e) {
      System.out
          .println("Fehler in MainWindowController - handleSearchButtonAction");
      e.printStackTrace();
    }
  ...
  private void handleConfigButtonAction(ActionEvent event) {
    ...
    try {
      ...
      main.getPrimarayStage()
          .setTitle(main.getTitle() + " - " + "Einstellungen");
      ...
      System.out
          .println("Fehler in MainWindowController - handleConfigButtonAction");
      e.printStackTrace();
    }
  }
  ...
  void menuBarHelpOpen(ActionEvent event) {
    ...
    try {
      secondaryLayout = FXMLLoader
          .load(getClass().getResource("../fxml/HelpWindow.fxml"));
    } catch (IOException e) {
